       ...
       <Container className='' fluid style={{position: 'absolute', marginTop: "auto"}}>
            <Row className='bg-dark'>
                <Col xs={12} md={6} lg={3} className=''>
                   ...
                   <div className='justify-content-start flex-wrap'>
                   <a class="bi bi-whatsapp text-light btn" href='https://www.whatsapp.com/?lang=es' target='_blank'>  54 9 3812 02-1097</a>
                   <a class="bi bi-envelope text-light btn" href='https://www.gmail.com/mail/help/intl/es/about.html?iframe' target='_blank'> emd.modelsagency@gmail.com</a>
                   <a class="bi bi-instagram text-light btn" href='https://www.instagram.com/emd.modelsagency/' target='_blank'> emd.modelsagency</a>
                   <a class="bi bi-youtube text-light btn " href='https://www.youtube.com/@emdmodelsagency4902' target='_blank'> EMD Models Agency</a>
                   <a class="bi bi-geo-alt text-light btn " href='https://www.google.com.ar/maps/place/Av.+Aconquija+1900,+T4107+Yerba+Buena,+Tucum%C3%A1n/@-26.8129194,-65.2996752,17z/data=!3m1!4b1!4m6!3m5!1s0x942242d7642ecf67:0x697ae6b582d34865!8m2!3d-26.8129242!4d-65.2971003!16s%2Fg%2F11c26kfnvg?entry=ttu' target='_blank'> Av. Aconquija 1900 Yerba Buena</a>
                </div>
                <div className='my-5'>
                <h2 className='text-warning'>MODELS AGENCY</h2>
                </div>

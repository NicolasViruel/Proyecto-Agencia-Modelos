...
import logo from "../../Layout/Footer/img/imglogoactual.jpg"
...
const Footer = () => {
  return (
      <>
       <Container className='container' fluid style={{position: '', marginTop: ""}}>
          ...
          <div className='d-flex flex-column align-items-start container-fluid'>
                 ...
                 <div className='d-flex flex-row m-1 p-5'>
                  <div><img src={img1} alt="sponsor1" className='w-50' /></div>
                  <div><img src={img2} alt="sponsor1" className='w-50' /></div>
                  <div><img src={img3} alt="sponsor1" className='w-50' /></div>
                  <div><img src={img4} alt="sponsor1" className='w-50' /></div>
                  <div><img src={img5} alt="sponsor1" className='w-50' /></div>
                  <div><img src={img6} alt="sponsor1" className='w-50' /></div>
                  <div><img src={img7} alt="sponsor1" className='w-50' /></div>
                  <div><img src={img8} alt="sponsor1" className='w-50' /></div>
                 </div>
             
          </section>
          <div className='my-5 text-start d-flex flex-row'>
                  <a href="/">
                  <img src={logo} alt="logo empresa" className='w-100 btn' id='logo' href="/"/>
                  </a>

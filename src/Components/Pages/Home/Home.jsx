...
const Home = () => {
  return (
    <section className="container">
     ...
     <a className=" btn btn-outline-dark" href="/error404">Conoce a nuestro staff</a>
     </div>
     <hr />
    ...
    <Calesita1></Calesita1>
    <div className="text-center m-3"> 
     <a className=" btn btn-outline-dark" href="/Error404">Conocer todos los eventos</a>
     </div>
     <h1 className="text-center py-2 display-2">Conoce nuestra agencia</h1>
     <div className="container justify-content-center">
     <img src={mod7} alt="modelos" className="d-block rounded-3 d-flex"/>
     </div>
     <div className="text-center m-3">
     <a className="btn btn-outline-dark" href="/Error404" >Conocer la agencia</a>
     </div>

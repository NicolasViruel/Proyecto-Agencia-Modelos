  ...
  return (
    <Container className="bg-light">
      ...
      <MDBCard className="m-3">
        ...
        <MDBCardBody>
          <MDBCardTitle className="text-center my-3">Maria Jose Topa</MDBCardTitle>
          <MDBCardText>
      ...
      <MDBCard className="m-3">
        ...
        <MDBCardBody>
          <MDBCardTitle className="text-center my-3">Emilse Cabrera</MDBCardTitle>
          <MDBCardText>
            <p style={{ fontWeight: 'bold' }}>CODIRECTORA</p>
            <p>Modelo Profesional</p>
            <p>Coach de modelos</p>
      ...
      <MDBCard className="m-3">
        ...
        <MDBCardBody>
          <MDBCardTitle className="text-center my-3">Denice Gomez Veliz</MDBCardTitle>
          <MDBCardText>
            <p style={{ fontWeight: 'bold' }}>CODIRECTORA</p>
            <p>Modelo Profesional</p>
            <p>Miss Argentina</p>
